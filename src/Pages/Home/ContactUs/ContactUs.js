                ...
                <div>
                    <form>
                        <div className=' flex flex-col lg:w-[50%] sm:w-[70%] w-[90%] mx-auto  text-black'>
                            <input type="email" name="email" placeholder='Email Address' className=' my-5 p-4 rounded-lg' />
                            <input type="text" name='subject' placeholder='Subject' className='mb-5 p-4 rounded-lg' />
                            <input type="text" name='message' placeholder='Your Message' className=' mb-9 py-8 px-4 rounded-lg' />
                        </div>
                        <div className='flex'>
